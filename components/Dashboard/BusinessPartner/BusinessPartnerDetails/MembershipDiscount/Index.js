...
import { NEXT_PUBLIC_API_ENDPOINT } from '../../../../../helpers/enums';

const getMembershipAmount = async (id) => {
  try {
    const response = await fetch(
      `${NEXT_PUBLIC_API_ENDPOINT}/flaer_platform/v1/platform/total_membership_discounts?business_partner_id=${id}`,
      {
        method: 'GET',
        headers: {
